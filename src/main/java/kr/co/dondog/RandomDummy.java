...
//   }
   ...
   private static Random getRandom() {
    ...
    public static String nAge() {
        // 19살부터 65살까지 랜덤한 생년월일 생성
        int birthYear = ThreadLocalRandom.current().nextInt(1958, 2005); // 19세에서 64세까지의 범위로 수정
        int birthMonth = ThreadLocalRandom.current().nextInt(1, 13);
        int birthDay = ThreadLocalRandom.current().nextInt(1, 29); // 간단하게 1일부터 28일로 설정

        // 주민등록번호 형식으로 반환 (YYMMDD)
        return String.format("%02d%02d%02d", birthYear % 100, birthMonth, birthDay);
    }

    private static String generateRandomEmail() {
        List<String> domains = Arrays.asList("gmail.com", "kakao.com", "naver.com");
    ...
    public static String nGender() {
        List<String> genders = Arrays.asList("1", "2");
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 20000; i++) {
            ...
            System.err.print("INSERT INTO dondog_member (email, mname, pwd, address, birth, gender) VALUES ('");
//            System.err.print(nId() + nNo2() + "', '");
            System.err.print(nEmail() + "', '");
            System.err.print(nName() + "', '");
            System.err.print("$2a$10$H7EnLIRAnU1EADGchIixQOLxmkAxMyRkjyeNFMwrjuS8Vk0QRB4ga" + "', '");
            System.err.print("혜화동" + "', '");
