...
public class ChatRoomController {
	...
	/*
	 * chatRoomEntity : 생성,출력 list로 jsp 페이지에 출력할 때 chatRoomVO : 채팅방 전달하는 내용
...
//			return "chat/roomList";
	...
	public Map<String, Object> getRoomInfo(@PathVariable(value = "room_id") String room_id,
...
//	public void messageSend(ChatMessageVO chatMessage) {
//
//	// 메시지 저장을 하는 로직
//
//	// 상대방에게 전달하는 
