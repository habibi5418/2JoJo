...
<body>
	...
	<div>
		<button id="connectBtn" type="button" class="btn btn-secondary">mqtt 연결 - 1</button>
		<button id="connectBtn2" type="button" class="btn btn-secondary">mqtt 연결 - 3</button>
		<button id="connectBtn3" type="button" class="btn btn-secondary">mqtt 연결 - 3</button><br>
		<button id="startBtn" type="button" class="btn btn-primary">위치보기</button>
		<div>
